...
// ф-ии могут находиться внутри объектов
...
const obj1 = {
  ...
  min: (a, b) => (a < b ? a : b),
  dec: a => --a,
  //имя этой ф-ии будет не powName а то что лежит в powName
  [powName](a, b) {
    return Math.pow(a, b);
  }
};
...
console.log('obj1.dec.name = ' + obj1.pow.name);
